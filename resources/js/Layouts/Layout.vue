<template>
  <div class="flex">
    ...
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">LAREN MACABITAS</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <div class="flex items-center px-4 -mx-2">
                <img class="object-cover mx-2 rounded-full h-9 w-9" src="https://scontent.fmnl9-2.fna.fbcdn.net/v/t1.0-9/148442610_432125231570839_2523501448373209644_o.jpg?_nc_cat=111&ccb=1-3&_nc_sid=09cbfe&_nc_eui2=AeGoieDeVO7FzA_ZJtsPnxVSnEdbohUo41icR1uiFSjjWPzTOeHT0ffEFbU6ruDmB64KVyfD2KNjoBUKcAiTxppN&_nc_ohc=w8JlXAfIJTYAX9dk15o&_nc_ht=scontent.fmnl9-2.fna&oh=351dc53435d8d98d22078b97eb35075b&oe=60859D0D" alt="avatar">
                <h4 class="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">Laren</h4>
            </div>
        </div>
    </div>
    ...
    <nav class="bg-white shadow dark:bg-gray-800">
        <div class="container px-6 py-3 mx-auto md:flex">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-xl font-bold text-gray-800 dark:text-white md:text-2xl hover:text-gray-700 dark:hover:text-gray-300" href="#">LAREN MACABITAS</a>
                </div>
